...
describe("CaixaDaLanchonete", () => {
  const validaTeste = (formaDePagamento, resultadoEsperado, itens) => {
    ...
    expect(resultado.replace("\xa0", " ")).toBe(resultadoEsperado);
  };
  test.each([
    [
      "com carrinho vazio",
  ...
  test.each([
    ...
    ["com quantidade zero", "credito", "Quantidade inválida!", ["sanduiche,0"]],
    ["com quantidade zero", "debito", "Quantidade inválida!", ["suco,0"]],
    ["com um valor", "credito", "Item inválido!", ["1"]],
    ["com um valor", "debito", "Item inválido!", ["2"]],
    ["com um valor", "dinheiro", "Item inválido!", ["3"]],
    ["com código inexistente", "debito", "Item inválido!", ["pizza, 1"]],
    ["com código inexistente", "dinheiro", "Item inválido!", ["bolo, 1"]],
    ["com código inexistente", "dinheiro", "Item inválido!", ["esfiha, 1"]],
    [
